import { 
// enums
TAG_End, TAG_Byte, TAG_Short, TAG_Int, TAG_Long, TAG_Float, TAG_Double, TAG_Byte_Array, TAG_String, TAG_List, TAG_Compound, TAG_Int_Array, TAG_Long_Array, NBT_Byte, NBT_Short, NBT_Int, NBT_Long, NBT_Float, NBT_Double, 
// funcs
getType } from "nbt.js";
import { obj_isEmpty, escapeObjectKey, repeatstr, skipSpaces } from "./util.js";
// Global objects
...
export const encodeRNBT = function (nbt, _format = true, indent = 2, colorize = false) {
...
export const decodeRNBT = function (str) {
    str = skipSpaces(str);
    let res;
